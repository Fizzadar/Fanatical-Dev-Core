<?php
	...
	class c_debug {
		...
		<div id="c_debug" style="position:fixed;top:0;left:0;width:98%;height:98%;background:#EEEEEE;color:#1A1B1B;font-family:Arial;text-shadow:none;font-size:13px;line-height:20px;padding:1%;z-index:99999999999998;display:none;overflow:auto;"><h2>Core Debug</h2>';
